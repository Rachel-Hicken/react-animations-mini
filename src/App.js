...
export default class App extends Component {
    constructor(props) {
        ...
        this.getDefaultSytles = this.getDefaultSytles.bind(this);
    ...
    getStyles(){
        return this.state.todos.map(todo =>{
            return Object.assign({}, todo, {style: {height: 65, opacity: 1}})
        })
    }
        ...
        return (
            <div className='app'>
                ...
                <div className='todos-wrap'>
                    ...
                    <TransitionMotion
                    defaultStyles={ this.getDefaultSytles()}
                    styles={this.getDefaultSytles()}
                    >
                        <div>
